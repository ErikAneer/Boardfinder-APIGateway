# What is the Boardfinder-APIGateway?

The Boardfinder-APIGateway is the Spring Zuul Gateway Service for the Boardfinder App that handles incoming requests to the Boardfider App.
